        ...
        try{
            try (PrintWriter writer = new PrintWriter(home + filename + ".txt", "UTF-8")) {
                ...
                while (plant_life_list_iterator.hasNext()) 
                {
                    ...
                    writer.println("Plant - x_pos:" + Integer.toString(plant_life.get_x_pos()) + " \ty_pos:"+ Integer.toString(plant_life.get_y_pos()) + "\tDiameter" + Double.toString(plant_life.get_diameter()) + "\tHeight:" + Double.toString(plant_life.get_height()));
                ...
                while (herbivore_list_iterator.hasNext()) {
                    ...
                    writer.println("Herbivore - x_pos:"+ Integer.toString(herbivore.get_x_pos()) + " \ty_pos"+ Integer.toString(herbivore.get_y_pos()) + "\tEnergy:" + Integer.toString(herbivore.get_energy()));
                ...
                while (predator_list_iterator.hasNext()) {
                    ...
                    writer.println("Predator - x_pos:"+ Integer.toString(predator.get_x_pos()) + " \ty_pos"+ Integer.toString(predator.get_y_pos()) + "\tEnergy:" + Integer.toString(predator.get_energy()));
           ...
           // do something
           System.out.println("There was an error outputing data...");
        }
